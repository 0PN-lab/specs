...
## What this is
This folder contains the **v1.2 consolidated packaging** that frames the 0PN Lab ISO/IEC 27560 profile work as a **Digital Consent Code of Conduct Profile**.
...
4) **v1.2 — Digital Consent (consolidated) (this folder)**  
